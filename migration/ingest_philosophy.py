...
==============================================================================
  ...
  Ingest a single agent:
      py -3.11 migration/ingest_philosophy.py --agent buffett

  Ingest every registered agent that has a philosophy folder:
      py -3.11 migration/ingest_philosophy.py --all

  Dry run (chunk + report, but write NOTHING to MongoDB and skip embedding):
      py -3.11 migration/ingest_philosophy.py --agent buffett --dry-run
